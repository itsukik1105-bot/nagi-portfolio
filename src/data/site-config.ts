export const siteConfig = {
  ...
  about: {
    ...
    // プロフィール画像
    profileImage: "https://storage.googleapis.com/studio-design-asset-files/projects/bXqzDJDpWD/s-1477x1108_v-fms_webp_863090aa-947f-4cda-89e5-0336889d9697.jpg",

    // 【重要】3段構成に合わせて文章を3つの要素に整理しました
    bio: [
      // ① BACKGROUND (生い立ち・学歴・背景)
      "2004年、神奈川県川崎市生まれ。　デジタルネイティブ世代として育ち、幼少期から映像表現に親しむ。",
      
      // ② CAREER (経歴・活動内容)
      "大学入学を機に映像制作を本格的に開始。学生団体でのプロジェクトを通じて、企画・撮影・編集まで一貫して担当し、ストーリーテリングの技術を磨く。NewsPicks Studiosや電通クリエイティブピクチャーズでのインターンシップを経験し、商業映像制作の現場を学ぶとともに、クライアントワークにおけるコミュニケーション能力も向上させた。",
      
      // ③ VISION (アピールポイント・展望)
      "物語×デジタル×体験の創出を目指している。映像とインタラクティブメディアの融合により、観る者が能動的に関与できる新しい表現形式を模索中。テクノロジーとアートの境界を超えた革新的なメディアの未来を切り拓くことを志す。"
    ],
    ...
    experience: [
      ...
      {
        period: "2024 - Present",
        company: "NewsPicks Studios",
        position: "Assistant Director (Intern)",
        description: "オウンドメディアの番組制作補助を担当。リサーチ業務から収録現場のディレクション補助、Premiere Proを用いた編集業務まで、番組制作の現場で実務経験を積む。"
      },
      {
        period: "2023 - Present",
        company: "慶應義塾放送研究会",
